<template>
  <div class="demo-page">
    ...
    <!-- 共享展示组件：4 stat 卡 + 三组实验 -->
    <section class="section">
      <DisambiguationShowcase :compact="false" />
    </section>
...
.compare-col.disamb { border-color: #3B82F630; }
.compare-label {
  font-size: 10px;
...
.footer-link-primary:hover { color: #2563eb; }
